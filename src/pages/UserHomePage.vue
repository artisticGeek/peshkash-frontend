    ...
    <main class="uh-shell">
      ...
      <template v-else>
        ...
        <template v-else-if="isPreferencesPage">
          <section class="uh-heading"><div><p class="uh-section-kicker">Updates</p><h2>Stay in the loop</h2></div></section>
          <p class="uh-preferences-intro">Choose how Peshkash may reach you. These choices apply across your account.</p>
...
async function loadPreferences(){settings.value=await axios.get<CommunicationSettings>(`${API_BASE_URL}/user/communication-settings`).then(response=>response.data)}
