        ...
        <Transition name="pk-drawer-slide" appear>
          ...
          >
            ...
            <nav class="pk-drawer-links" aria-label="Peshkash links">
              ...
              <button v-if="installAvailable" type="button" @click="openInstall"><span>Install Peshkash</span><i class="bi bi-phone"></i></button>
...
const { installAvailable } = usePwaLifecycle()
...
function openInstall() {
  closeDrawer()
  window.dispatchEvent(new CustomEvent('peshkash:open-install'))
}
