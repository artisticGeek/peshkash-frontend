...
const ACTION_LABEL: Record<string, string> = {
  ...
  landing_page_view: 'Landing Page View', landing_whatsapp_hero: 'Hero WhatsApp',
  landing_demo_anchor: 'See It in Action', landing_whatsapp_business: 'Business WhatsApp',
  landing_whatsapp_faq: 'FAQ WhatsApp', landing_whatsapp_contact: 'Contact WhatsApp',
  landing_get_started: 'Get Started', landing_whatsapp_nav: 'Navigation WhatsApp',
  landing_call: 'Landing Phone Call', landing_email: 'Landing Email',
